...
public class dashboardDataSiswa extends contentPanel {
    ...
    public dashboardDataSiswa(mainFrame parentApp, dashboardAdminView parentView) {
        super();
    ...
    private void setLayout() {
        headerLabel = new textLabel("Data Siswa", 40, 0, 300, 80);
